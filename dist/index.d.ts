export { AuthenticationError, ConnectionClosedError, connect, type Connection, type ConnectOptions, type DatasetClient, type DatasetNamespace, type DatasetReadOptions, type FeedLiveOptions, type FeedRecoveryOptions, type DatasetStreamFeedOptions, type MemoryStreamFeed, type CatalogFeedOptions, type MemoryCatalogFeed, type MultiRequestHandle, type MultiSelectedClient, type SelectedClient, type DatasetRecord, type RequestHandle, type ResolvedMarketDataMessage, type LatestOptions, type LatestStreamOptions, type StreamMetadataParameters, type TraceContext, type TsCandleOptions, type TsCandleStreamOptions, type TsRawOptions, type TsRawStreamOptions, type TimeseriesPage, type TimeseriesPageCursor, type TimeseriesPageOptions, type TimeseriesPageOrder, } from "./connection.js";
