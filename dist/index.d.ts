export { AuthenticationError, ConnectionClosedError, connect, type Connection, type ConnectOptions, type DatasetClient, type DatasetNamespace, type DatasetReadParameters, type MultiRequestHandle, type MultiSelectedClient, type SelectedClient, type CatalogParameters, type DatasetRecord, type RequestHandle, type ResolvedMarketDataMessage, type LatestParameters, type LatestStreamParameters, type StreamMetadataParameters, type TraceContext, type TsCandleParameters, type TsCandleStreamParameters, type TsRawParameters, type TsRawStreamParameters, } from "./connection.js";
